...
*/
    ...
    n("http://www.google-analytics.com/google_tag_data.glBridge.auto", function(a, b, c, d) {
        N();
        c = "fragment" === c ? 2 : 1;
        a = {
            callback: a,
    ...
    n("http://www.google-analytics.com/google_tag_data.glBridge.get", function(a, b) {
        var c = ca(!!b);
        b = L();
        b.data || (b.data = {
            query: {},
...
*/
            ...
            if (a.get(je)) {
                ...
                if (c) {
                    ...
                    var e = P(a, fe)
                      ...
                      , k = P(a, Na);
                    a = P(a, Be);
                    g && "http://www.google-analytics.com/aw.ds" != g ? b && (b.ua = !0) : (c = ["1", e, Cc(c)].join("."),
                    0 < d && (b && (b.ta = !0),
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/
      ...
      , td = function(a, b) {
        ...
        if ("cookie" == P(a, ac)) {
            ...
            d = a.get(ie),
            !c || d && "http://www.google-analytics.com/aw.ds" != d)) {
                c = {};
                if (M) {
                    d = [];
                    e = M.cookie.split(";");
    ...
    var u = function(a, b, c) {
      ...
      , y = function(a, b, c, d, e) {
        if (!ea(Yd.get(b)) && !$d.get(b)) {
            ...
            if (p.test(b)) {
                ...
                e || (g.event = "gtm.js"/*tpa=http://www.google-analytics.com/gtm.js*/
                );
                O[c].push(g);
                c = t(d)
            }
      ...
      , B = function(a) {
        ...
        return "http://www.google-analytics.com/www.google-analytics.com" == a.host && (a.port || b) == b && D(a.path, "/plugins/") ? !0 : !1
    }
      , ae = function(a) {
        function b(l) {
            var k = l.hostname || ""
